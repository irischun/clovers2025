...
const stylePromptMap: Record<string, string> = {
  ...
  irasutoya: "Irasutoya (いらすとや) Japanese clip-art illustration style by Mifune Takashi. CRITICAL VISUAL RULES: 1) COLORING: flat watercolor-wash fills with visible subtle paper grain/texture throughout, muted warm pastel palette (not glossy or smooth CG), colors slightly desaturated like real watercolor on textured paper. 2) OUTLINES: medium-thickness soft brown or dark outlines (NOT black), slightly wobbly hand-drawn feel, not perfectly geometric. 3) FACES: very simple — small dot eyes or tiny curved lines for eyes, simple curved line mouth, NO detailed eye highlights or anime-style eyes. SIGNATURE circular pink/salmon blush patches on BOTH cheeks (this is the most iconic feature). 4) PROPORTIONS: semi-chibi with head slightly larger than realistic but NOT extreme chibi, about 1:3 to 1:4 head-to-body ratio. Hands are simplified mittens or simple shapes. 5) HAIR: rendered as solid colored shapes with minimal internal detail, using dark brown or black fills. 6) SKIN: warm peachy-beige flat fill with the distinctive round rosy cheek blushes. 7) CLOTHING: simple flat colored shapes with minimal folds or shading, bright but muted primary colors (red, blue, green, orange). 8) OVERALL FEEL: friendly, educational, informational clip-art used in Japanese schools, hospitals, and offices. Clean white or transparent background. No complex shading, no gradients, no dramatic lighting. Simple, warm, approachable, instantly recognizable as いらすとや style.",
