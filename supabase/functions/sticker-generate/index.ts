...
const stylePromptMap: Record<string, string> = {
  ...
  irasutoya: "Irasutoya (いらすとや) Japanese clip-art illustration style by Mifune Takashi. ABSOLUTE RULE — THIS IS NOT A STICKER. It is a soft, gentle, flat Japanese clip-art illustration. NEVER add thick bold outlines, sticker borders, white outlines around the character, or any sticker-like aesthetic. OUTLINES: very THIN, SOFT warm brown lines — barely visible, like a faint pencil sketch under watercolor. Lines should almost disappear into the color fills. NOT thick, NOT bold, NOT black. COLORS: warm, muted, slightly desaturated gouache/poster-paint — think faded, gentle watercolor-like tones. Skin is soft warm peach (not vivid orange). Clothing uses GENTLE muted tones: soft red, dusty blue, sage green, warm mustard — like diluted poster paint. NOT neon, NOT highly saturated, NOT vibrant. Everything looks gently faded and warm. FACES: EXTREMELY simple — two tiny black dot eyes (just small circles), a simple small curved line for mouth. NO detailed eyes, NO pupils, NO eye highlights, NO anime eyes. MOST ICONIC: two perfectly round rosy-pink blush circles on BOTH cheeks, always present. PROPORTIONS: semi-realistic, slightly large head, about 1:3.5 to 1:4 head-to-body ratio. NOT chibi, NOT super-deformed. Natural body proportions with just slightly oversized head. TEXTURE: visible paper grain/tooth texture throughout, like gouache on textured off-white washi paper. Flat matte finish — NO glossy, NO smooth CG, NO gradients, NO shading, NO highlights, NO shadows. COMPOSITION: character on clean white/transparent background. NO decorative borders, NO sticker outlines. Simple, quiet, gentle, educational Japanese clip-art that looks like it belongs on a Japanese government pamphlet or elementary school handout. Reference: irasutoya.com",
