...
const stylePromptMap: Record<string, string> = {
  ...
  irasutoya: "Irasutoya (いらすとや) Japanese free illustration style, warm soft pastel colors with slightly muted tones, round friendly faces with signature circular pink blush on cheeks, simple dot or curved-line eyes, thick but soft outlines, slightly textured watercolor-like flat coloring with subtle grain, chibi-like proportions with large heads and small bodies, cheerful innocent expressions, clean simple shapes, educational clip-art quality, everyday life scenes, warm skin tones with rosy cheeks, gentle friendly atmosphere, informational diagram style, white or transparent background, cute approachable character design used in Japanese schools and offices",
