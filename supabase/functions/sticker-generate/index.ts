...
const stylePromptMap: Record<string, string> = {
  ...
  irasutoya: "Irasutoya (いらすとや) Japanese clip-art illustration style by Mifune Takashi. ABSOLUTE RULE — THIS IS NOT A STICKER. It is a soft, gentle, flat Japanese clip-art illustration. OUTLINES: ABSOLUTELY NO OUTLINES. Zero outlines. No border lines around the character or any element. No contour lines. Colors meet directly without any drawn line between them — shapes are defined purely by color fills touching each other, like cut paper collage or flat gouache paint areas. NEVER draw any outline, border, contour, or edge line in any color (not black, not brown, not any color). EXACT COLOR PANTONES (CRITICAL — match these precisely): Skin tone must be a soft warm peach around HSL(25, 70%, 82%) — gently pinkish-beige, NOT orange, NOT tan, NOT yellow. Hair must be very dark brown-black HSL(30, 25%, 18%) with subtle visible brush-stroke texture. Clothing colors must be WARM and MUTED like diluted gouache poster paint: soft dusty blue HSL(210, 30%, 65%), warm muted red HSL(5, 45%, 55%), sage green HSL(120, 25%, 55%), warm mustard yellow HSL(42, 55%, 60%), soft teal HSL(180, 25%, 55%). Background elements use warm beige HSL(35, 40%, 85%). ALL colors must look like they were painted with slightly watered-down gouache on textured paper — faded, gentle, warm-toned. NEVER use saturated, vivid, neon, or cool-toned colors. Everything should feel gently sun-faded and cozy. FACES: EXTREMELY simple — two tiny black dot eyes (just small circles, NO pupils, NO highlights, NO anime eyes, NO detailed iris). A simple small curved line for mouth. NOSE: The nose MUST be rendered as a SINGLE TINY RED-PINK DOT (approximately HSL(0, 60%, 65%)) — just one small round dot placed in the center of the face where the nose would be. NOT a drawn nose shape, NOT a triangle, NOT nostrils, NOT a line — ONLY a tiny round reddish-pink dot. EYELASHES — STRICT RULE FOR ALL FEMALE CHARACTERS: Every female character MUST have EXACTLY ONE (1) single tiny eyelash on each eye — one lash per eye, two lashes total. BOTH eyelashes MUST curve in the SAME DIRECTION: both curving upward and outward to the character's right side (viewer's left), like two matching tiny flicks. They must be SYMMETRICAL MIRROR images of each other — the left eye lash flicks outward-left and the right eye lash flicks outward-right, but BOTH curve upward with the same arc angle and length. Do NOT make one point up and the other point sideways. Do NOT make them curl in opposite vertical directions. They should look like a matched pair. Each lash is a very short, subtle, thin curved stroke — barely visible, like a tiny flick from the outer top corner of each eye dot. The count is NON-NEGOTIABLE: ONLY ONE per eye. NOT zero, NOT two per eye, NOT three or more. Male characters must have ZERO eyelashes. This eyelash rule is the KEY differentiator between male and female faces in Irasutoya style. MOST ICONIC: two perfectly round rosy-pink blush circles (HSL(350, 55%, 75%)) on BOTH cheeks, always present, slightly larger than the eye dots. PROPORTIONS: semi-realistic, slightly large head, about 1:3.5 to 1:4 head-to-body ratio. NOT chibi, NOT super-deformed. Natural body proportions with just slightly oversized head. TEXTURE: visible paper grain/tooth texture throughout, like gouache on textured off-white washi paper. Flat matte finish — NO glossy, NO smooth CG, NO gradients, NO shading, NO highlights, NO shadows. COMPOSITION: character on clean white/transparent background. NO decorative borders, NO sticker outlines. Simple, quiet, gentle, educational Japanese clip-art that looks like it belongs on a Japanese government pamphlet or elementary school handout. Reference: irasutoya.com",
