    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Link 
          ...
          className="relative overflow-hidden bg-gradient-to-br from-amber-500/10 via-yellow-500/5 to-orange-500/10 border border-amber-500/30 rounded-2xl p-6 hover:border-amber-500/50 transition-all group hover:shadow-lg hover:shadow-amber-500/10"
        >
          ...
          <div className="relative">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-xl bg-gradient-to-br from-amber-500 to-yellow-500 text-white shadow-lg shadow-amber-500/30">
                  <Crown className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-sm text-muted-foreground">已訂閱方案</span>
                  {subscriptionLoading ? (
                    <Loader2 className="w-5 h-5 animate-spin text-amber-500 mt-1" />
                  ) : (
                    <h3 className="text-xl font-bold text-amber-600 dark:text-amber-400 group-hover:text-amber-500 transition-colors">
          ...
          <ArrowRight className="absolute bottom-6 right-6 w-5 h-5 text-amber-500/50 group-hover:text-amber-500 group-hover:translate-x-1 transition-all" />
        </Link>

        {/* Points Card */}
        <Link 
          to="/dashboard/buy-points"
          className="relative overflow-hidden bg-gradient-to-br from-primary/10 via-primary/5 to-emerald-500/10 border border-primary/30 rounded-2xl p-6 hover:border-primary/50 transition-all group hover:shadow-lg hover:shadow-primary/10"
        >
          <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-primary/20 to-transparent rounded-full blur-2xl" />
          <div className="relative">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="p-3 rounded-xl bg-gradient-to-br from-primary to-emerald-500 text-white shadow-lg shadow-primary/30">
                  <Coins className="w-6 h-6" />
                </div>
                <div>
                  <span className="text-sm text-muted-foreground">所剩點數</span>
                  {pointsLoading ? (
            ...
            {monthlyPoints > 0 && (
              <div className="space-y-2">
                ...
                <Progress value={pointsUsagePercent} className="h-2" />
              </div>
            )}
          ...
          <ArrowRight className="absolute bottom-6 right-6 w-5 h-5 text-primary/50 group-hover:text-primary group-hover:translate-x-1 transition-all" />
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((stat) => (
          <div
            key={stat.title}
            className={`relative overflow-hidden bg-gradient-to-br ${stat.gradient} border border-border rounded-xl p-6 hover:border-primary/50 transition-all hover:shadow-md group`}
          >
            <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-bl from-current opacity-10 rounded-full blur-2xl" />
            <div className="relative">
